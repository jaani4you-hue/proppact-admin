...
import { deleteComplaint } from '../../services/complaintService.js';

export default function ComplaintDeleteDialog({ complaint, onClose, onDeleted }) {
      ...
      <div className="w-full max-w-sm rounded-2xl bg-white shadow-xl">
        <div className="flex items-center justify-between border-b border-gray-100 px-5 py-4">
          <div className="flex items-center gap-2">
            ...
            <h3 className="font-semibold text-gray-900">Delete Complaint</h3>
          </div>
        ...
        <div className="p-5">
          <p className="text-sm text-gray-600">
            Delete complaint{' '}
            <span className="font-semibold text-gray-900">{complaint.complaintNumber}</span>?
