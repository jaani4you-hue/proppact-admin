...
import { deleteRent } from '../../services/rentService.js';

export default function RentDeleteDialog({ rent, onClose, onDeleted }) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div className="w-full max-w-sm rounded-2xl bg-white shadow-xl">
        ...
        <div className="px-5 pt-4 pb-5">
          <h3 className="text-base font-semibold text-gray-900">Delete Rent Record?</h3>
          <p className="mt-1 text-sm text-gray-500">
            This will permanently delete the rent record for{' '}
            <span className="font-medium text-gray-700">{rent.tenantName}</span>
            {rent.propertyName ? ` at ${rent.propertyName}` : ''}.
            Payment history and receipts will remain in Firestore.
          </p>
          {error && (
