...
export default function OwnerDeleteDialog({ owner, loading, onConfirm, onCancel }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-sm rounded-2xl bg-white shadow-xl border border-gray-100 p-6">
        ...
        <h3 className="text-center text-base font-semibold text-gray-800 mb-1">Delete Owner</h3>
        <p className="text-center text-sm text-gray-500 mb-6">
          Are you sure you want to delete{' '}
          <span className="font-semibold text-gray-700">{owner.fullName}</span>? This
          action cannot be undone and will permanently remove all associated data and files.
        </p>
