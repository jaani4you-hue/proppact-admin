export default function OwnerSkeletonTable({ rows = 8 }) {
  return (
    <>
      {Array.from({ length: rows }).map((_, i) => (
        <tr key={i} className="border-b border-gray-50">
          ...
          <td className="py-3.5 px-3"><div className="h-3 w-16 rounded bg-gray-200 animate-pulse" /></td>
...
export function OwnerSkeletonCards({ rows = 5 }) {
  return (
