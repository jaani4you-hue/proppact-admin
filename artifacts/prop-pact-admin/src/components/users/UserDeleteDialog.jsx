...
export default function UserDeleteDialog({ user, loading, onConfirm, onCancel }) {
  if (!user) return null;
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-sm rounded-2xl bg-white shadow-xl border border-gray-100 p-6">
        ...
        <h3 className="text-center text-base font-semibold text-gray-800 mb-1">Delete User</h3>
